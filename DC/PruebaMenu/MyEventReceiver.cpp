        ...
        switch(event.GUIEvent.EventType)
        {
            ...
            switch(id)
            {
				...
				case GUI_ID_JUGAR_BUTTON:
					...
					env->addButton(rect<s32>(500,310,600,310 + 32), 0, GUI_ID_VOLVER_BUTTON, L"Volver", L"Menu Anterior");


					ant = GUI_ID_PRINCIPAL_BUTTON;
